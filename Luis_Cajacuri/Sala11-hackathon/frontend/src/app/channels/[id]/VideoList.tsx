  ...
  return (
    <section className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      ...
      <div className="px-6 py-4 bg-slate-50/50 border-b border-slate-200 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
          <h3 className="font-bold text-slate-800">Videos del canal ({processedVideos.length})</h3>
        </div>
      ...
      {processedVideos.length === 0 ? (
        <div className="py-12 text-center text-xs text-slate-600">No se encontraron videos.</div>
      ) : (
        <div>
